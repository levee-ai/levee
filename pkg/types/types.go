...
// ReservationID identifies a single in-flight budget reservation. It is a
// uint64 generated by an atomic counter in the budget store. The zero value is
// invalid and is returned by Reserve when no reservation was created (budget
// did not fit). See docs/architecture/001-error-handling.md.
